...
DROP TABLE IF EXISTS AM_GATEWAY_TIER_MAPPING;
CREATE SEQUENCE IF NOT EXISTS AM_GATEWAY_TIER_MAPPING_PK_SEQ;
CREATE TABLE IF NOT EXISTS AM_GATEWAY_TIER_MAPPING (
    ID INTEGER DEFAULT NEXTVAL('AM_GATEWAY_TIER_MAPPING_PK_SEQ'),
    GATEWAY_UUID VARCHAR(45) NOT NULL,
    LOCAL_TIER_NAME VARCHAR(255) NOT NULL,
    REMOTE_PLAN_REFERENCE JSONB NOT NULL,
    FOREIGN KEY (GATEWAY_UUID) REFERENCES AM_GATEWAY_ENVIRONMENT(UUID) ON DELETE CASCADE,
    PRIMARY KEY (ID),
...
CREATE TABLE IF NOT EXISTS AM_SUBSCRIPTION_EXTERNAL_MAPPING (
    UUID VARCHAR(255) NOT NULL,
...
CREATE TABLE IF NOT EXISTS AM_EXTERNAL_CREDENTIAL (
    UUID VARCHAR(255) NOT NULL,
...
DROP TABLE IF EXISTS AM_API_FEDERATION_CONFIG;
CREATE TABLE AM_API_FEDERATION_CONFIG (
    API_UUID VARCHAR(255) NOT NULL,
    GATEWAY_ENV_ID VARCHAR(255) NOT NULL,
    PUBLISHER_CURATED_CONFIG BYTEA,
