...
ApisApiService delegate = new ApisApiServiceImpl();
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @ApiOperation(value = "Create Federated Subscription ", notes = "Creates a WSO2 subscription for the given API and application and provisions the external gateway mapping. No credential is generated at this step. Returns the subscription UUID and provisioning status. ", response = FederatedSubscriptionCreateResponseDTO.class, authorizations = {
        @Authorization(value = "OAuth2Security", scopes = {
            @AuthorizationScope(scope = "apim:subscribe", description = "Subscribe API"),
            @AuthorizationScope(scope = "apim:sub_manage", description = "Retrieve, Manage subscriptions")
        })
    ...
    @ApiResponses(value = { 
        @ApiResponse(code = 201, message = "Created. Federated subscription created successfully. ", response = FederatedSubscriptionCreateResponseDTO.class),
        @ApiResponse(code = 400, message = "Bad Request. Invalid request or API is not a federated API. ", response = ErrorDTO.class),
        @ApiResponse(code = 409, message = "Conflict. Subscription already exists for this API and application. ", response = ErrorDTO.class),
        @ApiResponse(code = 500, message = "Internal Server Error.", response = ErrorDTO.class) })
    ...
    @Produces({ "application/json" })
    @ApiOperation(value = "Get API Credential Summaries ", notes = "Retrieves a list of federated credential summaries for all subscriptions to this API. Returns lightweight summary data suitable for rendering in a credentials table. ", response = FederatedCredentialSummaryListDTO.class, authorizations = {
        @Authorization(value = "OAuth2Security", scopes = {
            @AuthorizationScope(scope = "apim:subscribe", description = "Subscribe API"),
            @AuthorizationScope(scope = "apim:sub_manage", description = "Retrieve, Manage subscriptions")
        })
    ...
    @GET
    @Path("/{apiId}/federated-subscriptions")
    
    @Produces({ "application/json" })
    @ApiOperation(value = "Get API Subscription Summaries ", notes = "Retrieves a list of federated subscription summaries for all subscriptions to this API. Returns lightweight summary data suitable for rendering in a subscriptions table, including credential count per subscription. ", response = FederatedSubscriptionSummaryListDTO.class, authorizations = {
        @Authorization(value = "OAuth2Security", scopes = {
            @AuthorizationScope(scope = "apim:subscribe", description = "Subscribe API"),
            @AuthorizationScope(scope = "apim:sub_manage", description = "Retrieve, Manage subscriptions")
        })
    ...
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "OK. Subscription summaries retrieved successfully. ", response = FederatedSubscriptionSummaryListDTO.class),
        @ApiResponse(code = 404, message = "Not Found. The specified resource does not exist.", response = ErrorDTO.class),
        @ApiResponse(code = 500, message = "Internal Server Error.", response = ErrorDTO.class) })
    public Response getApiSubscriptionSummaries(@ApiParam(value = "**API ID** consisting of the **UUID** of the API. ",required=true) @PathParam("apiId") String apiId) throws APIManagementException{
        return delegate.getApiSubscriptionSummaries(apiId, securityContext);
    }

    @GET
    @Path("/{apiId}/subscription-support")
    
    @Produces({ "application/json" })
    @ApiOperation(value = "Check if API supports subscription-level authentication", notes = "Queries the external gateway to determine if the API requires subscriptions and what authentication types are supported. ", response = SubscriptionSupportInfoDTO.class, authorizations = {
        @Authorization(value = "OAuth2Security", scopes = {
            @AuthorizationScope(scope = "apim:subscribe", description = "Subscribe API")
        })
    }, tags={ "APIs",  })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "OK. Subscription support information retrieved successfully. ", response = SubscriptionSupportInfoDTO.class),
        @ApiResponse(code = 404, message = "Not Found. The specified resource does not exist.", response = ErrorDTO.class) })
    public Response getApiSubscriptionSupport(@ApiParam(value = "**API ID** consisting of the **UUID** of the API. ",required=true) @PathParam("apiId") String apiId) throws APIManagementException{
        return delegate.getApiSubscriptionSupport(apiId, securityContext);
    }
