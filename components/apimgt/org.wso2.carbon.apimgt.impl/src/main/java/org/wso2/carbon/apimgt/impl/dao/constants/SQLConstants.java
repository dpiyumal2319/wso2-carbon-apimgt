...
public class SQLConstants {
  ...
  //--------------------
    ...
    public static final String ADD_SUBSCRIPTION_EXTERNAL_MAPPING_SQL = "INSERT INTO AM_SUBSCRIPTION_EXTERNAL_MAPPING " +
            "(SUBSCRIPTION_UUID, GATEWAY_ENV_ID, EXTERNAL_SUBSCRIPTION_ID, REFERENCE_ARTIFACT, SELECTED_OPTION, " +
            "STATUS) VALUES (?, ?, ?, ?, ?, ?)";

    public static final String UPDATE_SUBSCRIPTION_EXTERNAL_MAPPING_SQL = "UPDATE AM_SUBSCRIPTION_EXTERNAL_MAPPING " +
            "SET EXTERNAL_SUBSCRIPTION_ID = ?, REFERENCE_ARTIFACT = ?, STATUS = ?, LAST_UPDATED_TIME = ? " +
    ...
    public static final String GET_SUBSCRIPTION_EXTERNAL_MAPPING_SQL = "SELECT EXTERNAL_SUBSCRIPTION_ID, " +
            "REFERENCE_ARTIFACT, SELECTED_OPTION, STATUS, CREATED_TIME, LAST_UPDATED_TIME " +
    ...
    public static final String ADD_API_FEDERATION_CONFIG_SQL = "INSERT INTO AM_API_FEDERATION_CONFIG " +
            "(API_UUID, GATEWAY_ENV_ID, FEDERATION_ENABLED, PUBLISHER_CURATED_OPTIONS, " +
            "GATEWAY_SNAPSHOT_HASH) VALUES (?, ?, ?, ?, ?)";

    public static final String GET_API_FEDERATION_CONFIG_SQL = "SELECT FEDERATION_ENABLED, " +
            "PUBLISHER_CURATED_OPTIONS, GATEWAY_SNAPSHOT_HASH, " +
    ...
    public static final String UPDATE_API_FEDERATION_CONFIG_PUBLISHER_SQL =
            "UPDATE AM_API_FEDERATION_CONFIG SET FEDERATION_ENABLED = ?, PUBLISHER_CURATED_OPTIONS = ?, " +
