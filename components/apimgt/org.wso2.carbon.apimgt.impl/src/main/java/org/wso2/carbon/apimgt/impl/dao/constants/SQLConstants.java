...
public class SQLConstants {
  ...
  //--------------------
    ...
    public static final String ADD_SUBSCRIPTION_EXTERNAL_MAPPING_SQL = "INSERT INTO AM_SUBSCRIPTION_EXTERNAL_MAPPING " +
            "(SUBSCRIPTION_UUID, GATEWAY_ENV_ID, EXTERNAL_SUBSCRIPTION_ID, EXTERNAL_CONTAINER_ID, " +
            "CREDENTIAL_REFERENCE, REFERENCE_ARTIFACT) VALUES (?, ?, ?, ?, ?, ?)";

    public static final String UPDATE_SUBSCRIPTION_EXTERNAL_MAPPING_SQL = "UPDATE AM_SUBSCRIPTION_EXTERNAL_MAPPING " +
            "SET EXTERNAL_CONTAINER_ID = ?, CREDENTIAL_REFERENCE = ?, REFERENCE_ARTIFACT = ?, " +
            "LAST_UPDATED_TIME = ? WHERE SUBSCRIPTION_UUID = ? AND GATEWAY_ENV_ID = ?";

    public static final String GET_SUBSCRIPTION_EXTERNAL_MAPPING_SQL = "SELECT EXTERNAL_SUBSCRIPTION_ID, " +
            "EXTERNAL_CONTAINER_ID, CREDENTIAL_REFERENCE, REFERENCE_ARTIFACT, CREATED_TIME, LAST_UPDATED_TIME " +
