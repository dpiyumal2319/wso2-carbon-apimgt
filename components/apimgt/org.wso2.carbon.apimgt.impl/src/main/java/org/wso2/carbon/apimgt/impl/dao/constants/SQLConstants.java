...
public class SQLConstants {
  ...
  //--------------------
    ...
    public static final String ADD_API_FEDERATION_CONFIG_SQL = "INSERT INTO AM_API_FEDERATION_CONFIG " +
            "(API_UUID, GATEWAY_ENV_ID, SUBSCRIPTION_ENABLED, PUBLISHER_CURATED_CONFIG, " +
            "GATEWAY_SNAPSHOT_HASH) VALUES (?, ?, ?, ?, ?)";

    public static final String GET_API_FEDERATION_CONFIG_SQL = "SELECT SUBSCRIPTION_ENABLED, " +
    ...
    public static final String UPDATE_API_FEDERATION_CONFIG_PUBLISHER_SQL =
            "UPDATE AM_API_FEDERATION_CONFIG SET SUBSCRIPTION_ENABLED = ?, PUBLISHER_CURATED_CONFIG = ?, " +
