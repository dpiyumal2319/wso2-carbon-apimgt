...
public class SQLConstants {
  ...
  //--------------------
    ...
    public static final String GET_API_CREDENTIAL_SUMMARIES_SQL = "SELECT s.UUID AS SUBSCRIPTION_UUID, " +
            ...
            "c.APPLICATION_ID, a.NAME AS APP_NAME, s.SUB_STATUS " +
            "FROM AM_EXTERNAL_CREDENTIAL c " +
    ...
    public static final String GET_API_SUBSCRIPTION_SUMMARIES_SQL = "SELECT m.SUBSCRIPTION_UUID, " +
            "m.UUID AS MAPPING_UUID, m.REFERENCE_ARTIFACT AS MAPPING_ARTIFACT, " +
            "m.CREATED_TIME, " +
            "COALESCE(m.LAST_UPDATED_TIME, m.CREATED_TIME) AS LAST_UPDATED_TIME, " +
    ...
    public static final String ADD_API_FEDERATION_CONFIG_SQL = "INSERT INTO AM_API_FEDERATION_CONFIG " +
            "(API_UUID, GATEWAY_ENV_ID, FEDERATION_ENABLED, PUBLISHER_CURATED_CONFIG, " +
            "GATEWAY_SNAPSHOT_HASH) VALUES (?, ?, ?, ?, ?)";

    public static final String GET_API_FEDERATION_CONFIG_SQL = "SELECT FEDERATION_ENABLED, " +
    ...
    public static final String UPDATE_API_FEDERATION_CONFIG_PUBLISHER_SQL =
            "UPDATE AM_API_FEDERATION_CONFIG SET FEDERATION_ENABLED = ?, PUBLISHER_CURATED_CONFIG = ?, " +
