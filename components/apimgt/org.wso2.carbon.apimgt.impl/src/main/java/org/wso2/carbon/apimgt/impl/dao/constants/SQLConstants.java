...
public class SQLConstants {
  ...
  //--------------------
    ...
    public static final String ADD_SUBSCRIPTION_EXTERNAL_MAPPING_SQL = "INSERT INTO AM_SUBSCRIPTION_EXTERNAL_MAPPING " +
            "(SUBSCRIPTION_UUID, GATEWAY_ENV_ID, EXTERNAL_SUBSCRIPTION_ID, NAME, REFERENCE_ARTIFACT, " +
    ...
    public static final String UPDATE_SUBSCRIPTION_EXTERNAL_MAPPING_SQL = "UPDATE AM_SUBSCRIPTION_EXTERNAL_MAPPING " +
            "SET EXTERNAL_SUBSCRIPTION_ID = ?, REFERENCE_ARTIFACT = ?, LAST_UPDATED_TIME = ? " +
            "WHERE SUBSCRIPTION_UUID = ? AND GATEWAY_ENV_ID = ?";

    public static final String GET_SUBSCRIPTION_EXTERNAL_MAPPING_SQL = "SELECT EXTERNAL_SUBSCRIPTION_ID, " +
            "NAME, REFERENCE_ARTIFACT, SELECTED_OPTION, CREATED_TIME, LAST_UPDATED_TIME " +
    ...
    public static final String GET_SUBSCRIPTION_EXTERNAL_MAPPINGS_SQL = "SELECT GATEWAY_ENV_ID, EXTERNAL_SUBSCRIPTION_ID, " +
            "NAME, REFERENCE_ARTIFACT, SELECTED_OPTION, CREATED_TIME, LAST_UPDATED_TIME " +
            "FROM AM_SUBSCRIPTION_EXTERNAL_MAPPING WHERE SUBSCRIPTION_UUID = ?";

    public static final String GET_SUBSCRIPTION_BY_EXTERNAL_ID_SQL = "SELECT SUBSCRIPTION_UUID FROM " +
            "AM_SUBSCRIPTION_EXTERNAL_MAPPING WHERE EXTERNAL_SUBSCRIPTION_ID = ? AND GATEWAY_ENV_ID = ?";
    ...
    public static final String GET_API_CREDENTIAL_SUMMARIES_SQL = "SELECT m.SUBSCRIPTION_UUID, " +
            "m.NAME, m.SELECTED_OPTION, " +
            "CASE WHEN m.REFERENCE_ARTIFACT IS NOT NULL THEN 1 ELSE 0 END AS IS_PROVISIONED, " +
            "m.LAST_UPDATED_TIME, s.APPLICATION_ID, a.NAME AS APP_NAME, s.SUB_STATUS " +
