...
public class SQLConstants {
  ...
  //--------------------
    ...
    public static final String GET_API_KEY_APPLICATION_ASSOCIATION_COUNT_SQL =
            "SELECT COUNT(DISTINCT APPLICATION_UUID) AS ASSOCIATION_COUNT " +
                    "FROM AM_API_KEY_APPLICATION_MAPPING WHERE API_KEY_UUID = ?";
