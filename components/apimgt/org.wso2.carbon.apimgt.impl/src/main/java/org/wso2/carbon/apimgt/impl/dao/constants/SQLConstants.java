...
public class SQLConstants {
  ...
  //--------------------
    ...
    public static final String INSERT_GATEWAY_TIER_MAPPING_SQL = "INSERT INTO " +
            "AM_GATEWAY_TIER_MAPPING (GATEWAY_UUID, LOCAL_TIER_NAME, REMOTE_PLAN_REFERENCE) VALUES (?, ?, ?)";

    public static final String GET_GATEWAY_TIER_MAPPINGS_SQL =
            "SELECT LOCAL_TIER_NAME, REMOTE_PLAN_REFERENCE FROM AM_GATEWAY_TIER_MAPPING WHERE GATEWAY_UUID = ?";
