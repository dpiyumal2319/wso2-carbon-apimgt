...
public class SQLConstants {
  ...
  //--------------------
    ...
    public static final String GET_API_KEY_EXTERNAL_API_KEY_MAPPING_SQL =
            "SELECT REFERENCE_ARTIFACT FROM AM_API_KEY_EXTERNAL_API_KEY_MAPPING " +
                    "WHERE API_KEY_UUID = ? AND GATEWAY_ENV_ID = ?";
    ...
    public static final String DELETE_API_KEY_EXTERNAL_API_KEY_MAPPING_SQL =
            "DELETE FROM AM_API_KEY_EXTERNAL_API_KEY_MAPPING WHERE API_KEY_UUID = ? AND GATEWAY_ENV_ID = ?";
    ...
    public static final String UPDATE_API_KEY_EXTERNAL_API_KEY_MAPPING_KEY_UUID_SQL =
            "UPDATE AM_API_KEY_EXTERNAL_API_KEY_MAPPING SET API_KEY_UUID = ? WHERE API_KEY_UUID = ?";
    ...
    public static final String GET_EXTERNAL_GATEWAY_MAPPINGS_BY_API_ID_SQL =
            "SELECT GATEWAY_ENV_ID, REFERENCE_ARTIFACT FROM AM_API_EXTERNAL_API_MAPPING WHERE API_ID = ?";
